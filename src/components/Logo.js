...
class Logo extends React.Component {
    ...
    for (let i = 0; i < lines.length; i++) {
      ...
      if(alphaChance > 0.4) {
        ...
        if(colorChance > 0.8) {
          ...
          lines[i].style.stroke = tinycolor({r: ranGreyscale, g: ranGreyscale, b: ranGreyscale}).toHexString()
        }
  ...
  render() {
    return (
      <div className="logo" ref={mount => {this.mount = mount}}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 313.4 303.4">
          ...
          <path d="M180,36c38.5,0,74.6,15,101.8,42.2S324,141.5,324,180s-15,74.6-42.2,101.8S218.5,324,180,324s-74.6-15-101.8-42.2
