...
var jsc = {
	...
	pub : function (targetElement, opts) {
		...
		this.previewSize = 0; // (px) width of the color preview displayed in previewElement
		this.previewPadding = 0; // (px) space between color preview and content of the previewElement
